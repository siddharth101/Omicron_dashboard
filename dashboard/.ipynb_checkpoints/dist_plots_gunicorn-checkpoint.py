...
from dashboard.dashboard_utils import _coerce_dates, load_dataframe, _filter_key, filter_df
# -------------------------------
# Config & Data Loading
# -------------------------------
...
parser.add_argument(
    "--ifo",
    choices=["H1", "L1"],
    default=os.getenv("IFO", "L1"),   # <— read from env if present
...
print(f"[INFO] Dashboard is running at http://127.0.0.1:{args.port}/")
